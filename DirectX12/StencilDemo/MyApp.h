...
private:
	...
	static const inline std::array<std::wstring, 11> TEXTUER_FILE_NAMES = {
	...
	static const inline std::vector<std::vector<std::string>> MESH_NAMES = {
		std::vector<std::string>({"box", "grid", "sphere", "cylinder" }),
		std::vector<std::string>({"skull"}),
		std::vector<std::string>({"land"}),
		std::vector<std::string>({"water"}),
		std::vector<std::string>({"floor", "wall", "mirror"})
	};
